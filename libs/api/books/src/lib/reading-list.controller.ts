...
export class ReadingListController {
  ...
  async addFinishedFromReadingList(@Param() params,@Body() updatedItem: ReadingListItem) {
    return await this.readingList.addFinishedFromReadingList(params.id, updatedItem);
  }
}
